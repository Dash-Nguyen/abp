...
using gatling.Models.TokenAuth;
...
{
    public abstract class gatlingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static gatlingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(gatlingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<gatlingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<gatlingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<gatlingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<gatlingDbContext, Task<T>> func)
        {
            T result;
