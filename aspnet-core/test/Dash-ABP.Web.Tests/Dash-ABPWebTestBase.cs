...
namespace Dash-ABP.Web.Tests
{
    public abstract class Dash-ABPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Dash-ABPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Dash-ABPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Dash-ABPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Dash-ABPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Dash-ABPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Dash-ABPDbContext, Task<T>> func)
        {
            T result;
