...
namespace gatling.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly gatlingDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = gatlingConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(gatlingDbContext context)
        {
            _context = context;
        }
